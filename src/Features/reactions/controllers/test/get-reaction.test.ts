...
describe('Get', () => {
  ...
  describe('reactions', () => {
    it('should send correct json response if reactions exist in cache', async () => {
      ...
      jest
        .spyOn(ReactionsCache.prototype, 'getReactionsFromCache')
        .mockResolvedValue([[reactionData], 1]);

      await Get.prototype.reactions(req, res);
      expect(
        ReactionsCache.prototype.getReactionsFromCache
  ...
  describe('singleReactionByUsername', () => {
    it('should send correct json response if reactions exist in cache', async () => {
      ...
      const res: Response = reactionMockResponse();
      jest
        .spyOn(ReactionsCache.prototype, 'getSingleReactionByUsernameFromCache')
        .mockResolvedValue([reactionData, 1]);

      await Get.prototype.singleReactionByUsername(req, res);
      expect(
        ReactionsCache.prototype.getSingleReactionByUsernameFromCache
