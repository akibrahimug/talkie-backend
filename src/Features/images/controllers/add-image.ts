...
import { IBgUploadResponse } from '@image/interfaces/image.interfaces';
...
export class Add {
  ...
  public async profileImage(req: Request, res: Response): Promise<void> {
    ...
    const url = `https://res.cloudinary.com/doyg3ppyn/image/upload/v${result.version}/${result.public_id}`;
