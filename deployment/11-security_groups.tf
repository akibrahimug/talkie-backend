resource "aws_security_group" "bastion_host_sg" {
  ...
  description = "Allows SSH into bastion host instance. No http/https"
...
resource "aws_security_group" "alb_sg" {
 ...
 ingress = [
    ...
    },
    {
      ...
      protocol    = "TCP"
      cidr_blocks = [var.global_destination_cidr_block]
      description = "Allows HTTPS traffic to the application load balancer"
    }
  ]
  ...
  vpc_id = aws_vpc.main.id
   ...
   ingress = [
    ...
    },
    {
      ...
      description     = "Allows access to webServer through the bastion host"
    },
    {
      from_port       = 5000
      to_port         = 5000
